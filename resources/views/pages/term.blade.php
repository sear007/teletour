...
<div class="container bg-white position-relative shadow rounded" style='top: -50px'>
    <div class="p-2">
        ...
        <p>These terms and conditions outline the rules and regulations for the use of Teletour's Website, located at
            teletour.kh88.xyz.</p>

        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
            teletour.kh88.xyz if you do not agree to take all of the terms and conditions stated on this page.</p>
        ...
        <p>We employ the use of cookies. By accessing teletour.kh88.xyz, you agreed to use cookies in agreement with the
            Teletour's Privacy Policy. </p>
        ...
        <p>Unless otherwise stated, Teletour and/or its licensors own the intellectual property rights for all material
            on teletour.kh88.xyz. All intellectual property rights are reserved. You may access this from
            teletour.kh88.xyz for your own personal use subjected to restrictions set in these terms and conditions.</p>
        ...
        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
            areas of the website. Teletour does not filter, edit, publish or review Comments prior to their presence on
            the website. Comments do not reflect the views and opinions of Teletour,its agents and/or affiliates.
            Comments reflect the views and opinions of the person who post their views and opinions. To the extent
            permitted by applicable laws, Teletour shall not be liable for the Comments or for any liability, damages or
        ...
        <p>Teletour reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>You hereby grant Teletour a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
            ...
            Teletour; and (d) the link is in the context of general resource information.</p>
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
            you must inform us by sending an e-mail to Teletour. Please include your name, your organization name,
        ...
        <p>No use of Teletour's logo or other artwork will be allowed for linking absent a trademark license agreement.
        </p>
